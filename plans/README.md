...
| 004  | Migrate every screen onto the primitive layer   | P1       | **XL** | HIGH | 000, 003          | `e8cc678` (six PRs, sequential) | BLOCKED (decision 004-confirm-dialog-destructive-contrast) |
