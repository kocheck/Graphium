...
| 006a | Audit, three directions, IA, write 006b's steps | **P1**   | M      | LOW  | 000, 001, 003     | `e8cc678`                       | DONE 2aea4cd                                                       |
| 004  | Migrate every screen onto the primitive layer   | P1       | **XL** | HIGH | 000, 003          | `e8cc678` (six PRs, sequential) | DONE 0b66664                                                       |
| 005  | Fix the DOM-layer performance drags             | P2       | M      | MED  | 000, 001, **004** | `0b66664`                       | DONE 8d686c2                                                       |
| 006b | Apply the redesign                              | P2       | L      | MED  | 004, 005, 006a    | `8d686c2`                       | BLOCKED (step-9 world-legibility Arm audio 1.48:1 after one retry) |
