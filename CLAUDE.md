...
### Session 1: Cleanup & Quick Wins
- [ ] Delete 5 dead Vite boilerplate files
- [ ] Clean FogOfWarLayer diagnostic logging
- [ ] Optimize icon.png to <100KB
- [ ] Generate and document test coverage baseline
...
- Coverage baseline: TBD (Session 1)
- Branch: `claude/refactor-modular-architecture-GUfVC`
